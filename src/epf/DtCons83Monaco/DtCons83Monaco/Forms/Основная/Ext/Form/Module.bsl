...
Процедура УстановитьУсловноеОформлениеЗамеров()
	...
	ОбъектНастройки = Обработки.УсловноеОформление.Создать();
	...
	ОбъектНастройки
		...
		.Оформление("ЦветФона", ЦветаСтиля.ЦветКалендаряЗеленый)
		
		.Элемент("ТаблицыЗамер")
			.ГруппаИ()		
				.Отбор("Таблицы.Замер", "БольшеИлиРавно", ПределЖелтый)
				.Отбор("Таблицы.Замер", "Меньше", ПределКрасный)
		.Оформление("ЦветФона", ЦветаСтиля.ЦветКалендаряЖелтый)
		
		.Элемент("ТаблицыЗамер")
			.Отбор("Таблицы.Замер", "Больше", ПределКрасный)
		.Оформление("ЦветФона", ЦветаСтиля.ЦветКалендаряКрасный);
КонецПроцедуры
