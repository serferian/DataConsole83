...
Процедура ФайлСохранить(Команда)
	...
	Если Команда <> Команды.ФайлСохранитьКак
		...
		И Новый Файл(Объект.ПолноеИмяФайла).Существует()
...
Функция РассчитатьХешФайлаРабочейОбласти(ПолноеИмяФайла)
	Если ПустаяСтрока(ПолноеИмяФайла) Или Не Новый Файл(ПолноеИмяФайла).Существует() Тогда
		Возврат "";
	КонецЕсли;

	Попытка
		Хеширование = Новый ХешированиеДанных(ХешФункция.SHA256);
		Хеширование.ДобавитьФайл(ПолноеИмяФайла);
