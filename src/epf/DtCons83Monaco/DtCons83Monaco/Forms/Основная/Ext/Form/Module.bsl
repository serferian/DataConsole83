...
Процедура ЗаписатьСнимокРабочейОбластиВФайл(ПолноеИмяФайла, Знач Снимок)
	...
	СнимокДляЗаписи.Вставить("formatVersion", ДанныеСнимка.formatVersion);
	СнимокДляЗаписи.Вставить("sessionId", ДанныеСнимка.sessionId);
	СнимокДляЗаписи.Вставить("fileName", ДанныеСнимка.fileName);
	СнимокДляЗаписи.Вставить("modified", ДанныеСнимка.modified);
	СнимокДляЗаписи.Вставить("revision", ДанныеСнимка.revision);
	СнимокДляЗаписи.Вставить("fileHash", ДанныеСнимка.fileHash);
	СнимокДляЗаписи.Вставить("selectedAlgorithmId", ДанныеСнимка.selectedAlgorithmId);
	СнимокДляЗаписи.Вставить("selectedTableId", ДанныеСнимка.selectedTableId);
	СнимокДляЗаписи.Вставить("measurementsEnabled", ДанныеСнимка.measurementsEnabled);
	СнимокДляЗаписи.Вставить("tables", ДанныеСнимка.tables);
	СнимокДляЗаписи.Вставить("settings", ДанныеСнимка.settings);
	СнимокДляЗаписи.Вставить("algorithms", ДанныеСнимка.algorithms);
