...
Процедура ВыполнитьКодЗапроса(Знач Алгоритм, Знач ДополнительныеПараметры,
	...
	НачалоКолонки = 0;
	КонецКолонки = 0;
	Если ИспользоватьТекстРедактора И ТекстДокумента = Неопределено Тогда
	...
	Если ИспользоватьТекстРедактора И ТекстДокумента = Неопределено И Не ВыделенТекст Тогда
