...
define(['bslGlobals', 'bslMetadata', 'snippets', 'bsl_language', 'vs/editor/editor.main', 'actions', 'bslQuery', 'bslDCS', 'colors'], function () {
  ...
  updateText = function(txt, clearUndoHistory = true) {
    ...
    if (window.DataConsoleApp)
      window.DataConsoleApp.onLegacyContentSet();
  ...
  setTheme = function (theme) {
    ...
    if (window.DataConsoleApp)
      window.DataConsoleApp.syncTheme(theme);
  ...
  function createEditor(language_id, text, theme) {
    ...
    if (window.DataConsoleApp)
      window.DataConsoleApp.onEditorReady(editor);
  ...
  function initEditorEventListenersAndProperies() {
    ...
    editor.onDidChangeModelContent(e => {
      ...
      if (window.DataConsoleApp)
        window.DataConsoleApp.onEditorContentChanged();

      if (getOption('generateModificationEvent') &&
          (!window.DataConsoleApp || window.DataConsoleApp.shouldEmitContentChange()))
        sendEvent('EVENT_CONTENT_CHANGED', window.DataConsoleApp ? window.DataConsoleApp.getContentChangeEventParams() : '');
