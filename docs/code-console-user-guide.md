...
Руководство актуально для DataConsole83 5.0.12. Оно описывает рабочую область Monaco, консоль запросов и выполнение BSL-кода на клиенте, сервере и в фоне.
