...
Руководство актуально для DataConsole83 4.13.4. Оно описывает рабочую область Monaco, консоль запросов и выполнение BSL-кода на клиенте, сервере и в фоне.
